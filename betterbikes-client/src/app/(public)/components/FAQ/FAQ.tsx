...
const FAQ = () => {
  return (
    <section className="relative z-20 overflow-hidden bg-white text-main-foreground py-10 ">
      <div className="container mx-auto">
        <div className="-mx-4 flex flex-wrap">
          <div className="w-full px-4">
            <div className="mx-auto mb-[60px] text-center lg:mb-20">
              <span className="mb-2 block text-lg font-semibold ">FAQ</span>
              <h2 className="mb-4 text-3xl font-bold sm:text-4xl md:text-[40px]">
                Any Questions? Look Here
              </h2>
              <p className="text-base text-main-light">
...
const AccordionItem = ({ header, text }: any) => {
  ...
  return (
    <div className="single-faq mb-8 w-full rounded-lg border border-[#F3F4FE] bg-gray-100 p-4 sm:p-8 lg:px-6 xl:px-8 hover:bg-main-foreground color-transition hover:text-white group">
      <button
